...
class raysgrid_Base {
    ...
    public function rsgd_front_styles() {
        ...
        wp_enqueue_script( RSGD_PFX.'_assets', RSGD_URI . 'assets/public/js/assets.js', array('jquery') );
        wp_enqueue_script( RSGD_PFX.'_script', RSGD_URI . 'assets/public/js/script.js', array('jquery') );
